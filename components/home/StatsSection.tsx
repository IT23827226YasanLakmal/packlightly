...
export default function StatsSection() {
  ...
  return (
    <section className="py-16 flex flex-col items-center text-center bg-gradient-to-b from-green-50 via-green-100 to-green-50">
      <h2 className="text-3xl font-bold text-emerald-900 mb-2">🌱 Our Sustainability Impact</h2>
      <p className="text-green-700 mb-12 max-w-xl">
        Check out how our eco-conscious travelers and initiatives are making a difference globally.
      </p>
